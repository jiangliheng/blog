---
layout: post
title: "Redis 日常运维脚本（增加集群批量删除 key 功能）"
date: "2020-05-16 20:00"
category: ops-scripts
tags: Linux Shell Redis redis-tools.sh
author: jiangliheng
---
* content
{:toc}
...
[Redis 日常运维脚本](/2020/04/27/ops-redis/) 中的 ```redis-tools.sh``` 仅支持删除单个 key 和 全部清理，并未实现匹配特定前缀批量删除的功能。
